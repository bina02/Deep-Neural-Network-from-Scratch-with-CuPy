...
Therefore, considering $Z$ is passed into ReLU, when weight_matrix $= \text{weight\_matrix} \times \frac{2}{\sqrt{n_{\text{pred}}}}$, the variance of $g(Z)$ is maintained even as the model becomes deeper.
